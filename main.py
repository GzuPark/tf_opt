...
from tflite_image_classification_converter import get_result
...
def main() -> None:
    ...
    print(f"{'Method':>10} {'Accuracy':>12} {'Avg. time':>15} {'File size':>12}")
    for res in [res_origin, res_fp16, res_dynamic, res_uint8]:
        _method = res['method']
        _acc = res['accuracy'] * 100
        _time = res['avg_time']
        _size = res['model_file_size']
        print(f"{_method:>10} {_acc:>10.2f} % {_time:>15.7f} {_size:>12}")
