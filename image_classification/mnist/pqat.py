...
class PQATModel(BaseModel):
    ...
    def create_model(self) -> None:
        ...
        models = dict()
        models[TFOptimize.PruningQAT] = self._get_qat_model
        models[TFOptimize.PruningPQAT] = self._get_pqat_model

        target_model = models.get(self._optimizer, self._get_pqat_model)
